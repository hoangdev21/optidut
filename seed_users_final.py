...
def seed_users():
    users = [
        ...
        {'username': 'giangvien', 'vai_tro': NguoiDung.VaiTro.GIANG_VIEN, 'ho_ten': 'Lê Văn Giảng', 'ma_so': 'GV02'},
        {'username': 'sinhvien', 'vai_tro': NguoiDung.VaiTro.SINH_VIEN, 'ho_ten': 'Nguyễn Văn Sinh', 'ma_so': 'SV01'}
    ]
